...
const sendSimpleEmail = async (dataSend) => {
  ...
  let info = await transporter.sendMail({
    ...
    html: `
        ...
        <p>@Shipper sẽ gọi cho bạn theo số điện thoại <strong style="color:red">${dataSend.phone}</strong>, bạn vui lòng để ý điện thoại trong vài ngày tới,,đừng để shipper gọi nhiều lần mà không nghe máy nhé...Bshop mãi yêu :))</p>
        </div>
        <div>
